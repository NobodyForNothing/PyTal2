...
#define PYTAL_PRINT_COLOR Color(247, 214, 68)
#define PYTAL_PRINT_ACTIVE_COLOR Color(110, 247, 76)
...
public:
	...
	void Print(const char *fmt, T... args) {
		this->ColorMsg(PYTAL_PRINT_COLOR, fmt, args...);
	}
	template <typename... T>
	void PrintActive(const char *fmt, T... args) {
		this->ColorMsg(PYTAL_PRINT_ACTIVE_COLOR, fmt, args...);
	}
